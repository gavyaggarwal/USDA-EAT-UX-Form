...
var data1, data2, data3, data4, data5, data6, data7, generatePDF, incomeFrequency, incomeInfo, incomeType, memberName, studentInfo, test;
...
incomeInfo = function(person, child) {
  var i, personIncome, _i, _len, _ref;
  personIncome = '';
  if ((!child && !person.income) || (child && +person.income.amount === 0)) {
