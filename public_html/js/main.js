...
var baseURL, child, childIncomeTemplate, currentPanel, data, forwardPanelTransition, generatePDF, objectForFields, panel, panelStack, populateChildrenIncome, processChildrenInfo, processParentInfo, processProgramInfo, setUpButtons, setUpChildPanel, setUpDefinitions, setUpIncomePanel, setUpProgramPanel, setUpSubmitPanel, setUpValidation, showData, showNextPanel, showPreviousPanel, skipToSubmitPanel, submitForm, submitPanelIndex, updateProgressBar;
...
setUpButtons = function() {
  ...
  return $('#programInfoButton').click(function() {
