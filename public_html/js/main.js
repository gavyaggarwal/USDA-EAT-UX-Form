...
var adult, adultIncomeTemplate, baseURL, child, childIncomeTemplate, currentPanel, data, forwardPanelTransition, generatePDF, hasSSN, objectForFields, panel, panelStack, populateAdultIncome, populateChildrenIncome, processAdultInfo, processChildrenInfo, processIncomeInfo, processParentInfo, processProgramInfo, processSSNInfo, programParticipant, setUpButtons, setUpChildPanel, setUpDefinitions, setUpHouseholdPanel, setUpIncomePanel, setUpProgramPanel, setUpSSNPanel, setUpSubmitPanel, setUpValidation, showData, showNextPanel, showPreviousPanel, skipToSubmitPanel, submitForm, submitPanelIndex, updateProgressBar;
...
processChildrenInfo = function() {
  var allExempt, allValid, field, i, obj, res, val, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2;
  allValid = true;
  allExempt = true;
  ...
  if (allValid) {
    ...
    for (i = _i = 1; 1 <= child ? _i < child : _i > child; i = 1 <= child ? ++_i : --_i) {
      if (document.getElementById('child' + i + 'Form')) {
        ...
        _ref1 = ['student', 'foster', 'homeless', 'migrant', 'runaway', 'headStart'];
    ...
    if (allExempt || ((_ref2 = data.program) != null ? _ref2.participates : void 0)) {
...
processIncomeInfo = function() {
  var allValid, form, i, income, method, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
  allValid = true;
  ...
  if (allValid) {
    _ref = $('#childIncomeSection').find('form');
    ...
    _ref1 = $('#adultIncomeSection').find('form');
    for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
      form = _ref1[i];
      income = [];
      _ref2 = $(form).find('#adultIncomeType' + i).val();
...
setUpButtons = function() {
  ...
  $('#adultInfoButton').click(function() {
    return processAdultInfo();
  });
  $('#incomeInfoButton').click(function() {
    return processIncomeInfo();
  });
  return $('#ssnInfoButton').click(function() {
    return processSSNInfo();
  });
};
...
populateAdultIncome = function(adults) {
  var a, adultIncomeBoxes, adultIncomeSection, allAdults, box, externalIncome, i, jobIncome, newForm, otherIncome, _i, _j, _len, _len1, _ref, _results;
  ...
  for (i = _i = 0, _len = allAdults.length; _i < _len; i = ++_i) {
    ...
    $(newForm).find('#adultIncomeTypeTemplate').attr('id', 'adultIncomeType' + i).change(function() {
      var box, form, j, method, _j, _k, _len1, _len2, _ref, _ref1, _results1;
      form = $(this).closest('form');
      j = $(form).index();
      $('#adultIncomeForm' + i + ' .select-wrapper');
      _ref = adultIncomeBoxes[j];
